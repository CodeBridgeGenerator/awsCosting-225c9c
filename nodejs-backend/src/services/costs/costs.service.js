const { Costs } = require("./costs.class");
const createModel = require("./costs.model");
const hooks = require("./costs.hooks");
...
module.exports = function (app) {
  ...
  app.use("/costs", new Costs(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("costs");

  // Get the schema of the collections 
  app.get("/costsSchema", function (request, response) {
